...
class classAdminController extends FooController {
    ...
    public function __construct(Request $request) {
        ...
        //package name
        $this->package_name = 'package-class';
        $this->package_base_name = 'class';

        //root routers
        $this->root_router = 'classs';
        ...
        $this->category_ref_name = 'admin/classs';
    ...
    /**
     * Processing data from class method: add new item, edit existing item
     * @return view edit page
     * @date 27/12/2017
     */
    ...
    public function lang(Request $request) {
        ...
        $is_valid_request = $this->isValidRequest($request);
        // display view
        $langs = config('package-class.langs');
        $lang_paths = [];
        $package_path = realpath(base_path('vendor/foostart/package-class'));
