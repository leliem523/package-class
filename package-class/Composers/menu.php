...
*/
View::composer([
                'package-class::admin.post-edit',
                'package-class::admin.post-form',
                'package-class::admin.post-items',
                'package-class::admin.post-item',
                'package-class::admin.post-search',
                'package-class::admin.post-config',
                'package-class::admin.post-lang',
    ], function ($view) {
