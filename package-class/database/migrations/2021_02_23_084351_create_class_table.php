...
class CreateClassesTable extends FoostartMigration
{
    public function __construct() {
        $this->table = 'classes';
        $this->prefix_column = 'class_';
    }
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create($this->table, function (Blueprint $table) {
            ...
            $table->string($this->prefix_column . 'cache_other_classs', 1000)->nullable()->comment('The class id of related classes ');
